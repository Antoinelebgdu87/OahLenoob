...
export function GamblingWarning({ isOpen, onClose, className }: GamblingWarningProps) {
        ...
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-red-100 font-medium">
              Ça peut avoir des <span className="text-yellow-300 font-bold">CONSÉQUENCES</span>
            </p>
