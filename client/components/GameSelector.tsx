      ...
      <div className="w-full max-w-6xl">
        <div className="flex overflow-x-auto space-x-6 pb-4 px-4 scrollbar-hide">
          ...
          >
            <div className="space-y-3">
              <div className="w-12 h-12 bg-red-500 rounded-full flex items-center justify-center text-xl font-bold text-white border-2 border-red-400 mx-auto">
                R
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="w-12 h-12 bg-yellow-500 rounded-full flex items-center justify-center text-xl font-bold text-gray-900 border-2 border-yellow-400 mx-auto">
                S
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="w-12 h-12 bg-purple-500 rounded-full flex items-center justify-center text-xl font-bold text-white border-2 border-purple-400 mx-auto">
                C
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center text-xl font-bold text-white border-2 border-blue-400 mx-auto">
                D
              </div>
          ...
          >
            <div className="space-y-3">
              <div className="w-12 h-12 bg-pink-500 rounded-full flex items-center justify-center text-xl font-bold text-white border-2 border-pink-400 mx-auto">
                🐱
              </div>
        ...
        <div className="text-center mt-2">
          <div className="text-gray-400 text-sm">
            ← Faites défiler pour voir tous les jeux →
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
          <div className="bg-red-900/20 p-4 rounded-lg border border-red-500">
            ...
            <p className="text-gray-300">
              Cliquez pour faire tourner la roue. Elle s'arrête sur un nombre
              qui détermine vos gains automatiquement. Aucune stratégie requise
              !
            </p>
          </div>
          ...
          <div className="bg-yellow-900/20 p-4 rounded-lg border border-yellow-500">
            ...
            <p className="text-gray-300">
              Appuyez sur SPIN et regardez les 3 symboles. Si 3 symboles
              identiques apparaissent, vous gagnez le jackpot correspondant !
            </p>
          </div>
          ...
          <div className="bg-purple-900/20 p-4 rounded-lg border border-purple-500">
            ...
            <p className="text-gray-300">
              Le multiplicateur monte rapidement ! Vous devez cliquer
              "ENCAISSER" avant qu'il crash pour gagner. Plus vous attendez,
              plus vous gagnez... mais plus le risque est grand !
            </p>
          </div>
          ...
          <div className="bg-blue-900/20 p-4 rounded-lg border border-blue-500">
            ...
            <p className="text-gray-300">
              Choisissez un nombre et pariez si le dé sera "PLUS" ou "MOINS" que
              ce nombre. Plus votre prédiction est risquée, plus vous gagnez !
            </p>
          </div>
          ...
          <div className="bg-pink-900/20 p-4 rounded-lg border border-pink-500">
            ...
            <p className="text-gray-300">
              Nyan Cat s'envole ! Sauvez-le en cliquant "SAUVER LE CHAT" avant
              qu'il s'envole trop haut. Plus il monte, plus vous gagnez !
            </p>
          </div>
          ...
          <div className="bg-green-900/20 p-4 rounded-lg border border-green-500">
            ...
            <p className="text-gray-300">
              Avant chaque partie, entrez votre nom et choisissez votre mise.
              Vos résultats s'affichent dans l'historique sur le côté !
            </p>
          </div>
        </div>
      </div>
